...
const FilterButton = ({ children, onClick }) => (
  <button
    onClick={onClick}
    className="px-5 py-3 rounded-lg border border-[#8C9BB0]/30 text-[var(--primary-200)] 1font-medium hover:bg-[var(--primary-100)] transition-colors flex items-center gap-2"
  >
    {children}
  </button>
);
