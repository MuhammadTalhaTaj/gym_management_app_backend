...
const Select = ({ label, options, value, onChange }) => (
  <div className="flex flex-col gap-2">
    ...
    <select
      value={value}
      onChange={onChange}
      className="w-full px-4 py-3 bg-text-[var(--primary-300)] border border-gray-200 rounded-lg text-sm text-[var(--primary-100)] focus:outline-none focus:ring-2 focus:ring-[var(--tertiary-400)] focus:border-transparent transition-all appearance-none cursor-pointer"
      style={{
