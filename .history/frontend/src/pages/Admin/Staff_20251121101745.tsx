...
const FilterButton = ({ children, onClick }) => (
  <button
    onClick={onClick}
    className="px-5 py-3 rounded-lg border border-[#8C9BB0]/30 text-[var(--primary-300)] font-medium hover:bg-[var(--primary-100)] transition-colors flex items-center gap-2"
  >
    {children}
  </button>
);
  ...
  <div className="flex items-center justify-between mt-6">
    ...
    <div className="flex gap-2">
      <button
        ...
        className="px-4 py-2 rounded-lg border border-[#8C9BB0]/30 text-[var(--primary-300)] font-medium hover:bg-[var(--primary-200)] disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
      >
        Previous
      </button>
        ...
        <div className="bg-[var(--primary-100)] rounded-xl shadow-sm p-6 mb-6">
          <div className="flex flex-col lg:flex-row gap-4 items-start lg:items-center">
            ...
            <div className="flex flex-wrap gap-3">
              ...
              <button className="px-5 py-3 rounded-lg border border-[#8C9BB0]/30 text-[var(--primary-300)] font-medium hover:bg-[var(--primary-200)] transition-colors flex items-center gap-2">
