    ...
    <div className="relative">
      ...
      {showPasswordToggle && (
        <button
          ...
          className="absolute right-3 top-1/2 -translate-y-1/2 text-gray-400 hover:text-[var(--primary-100)] transition-colors"
        >
...
const AddStaff = () => {
  ...
  return (
    <div className="min-h-screen w-full bg-[var(--primary-200)]">
      {/* Header */}
      <header className="bg-[var(--primary-100)] text-white px-4 sm:px-6 lg:px-8 py-4">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-gray-400">Add new team member</p>
            </div>
          </div>
          <div className="flex items-center gap-3">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2">
            <Card className="p-6 sm:p-8">
              {/* Form Header */}
              <div className="bg-[var(--primary-200)] text-white -mx-6 sm:-mx-8 -mt-6 sm:-mt-8 px-6 sm:px-8 py-6 rounded-t-lg mb-8">
                <h2 className="text-xl font-bold mb-1">Add New Staff Member</h2>
                <p className="text-sm text-gray-300">Fill in the details to create a new staff account</p>
              </div>
