  ...
  <div className="flex items-center justify-between mt-6">
    ...
    <div className="flex gap-2">
      ...
      <button
        ...
        className="px-4 py-2 rounded-lg border border-[#8C9BB0]/30 text-[var(--primary-300)] font-medium hover:bg-[var(--primary-100)] disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
      >
        Next
      </button>
    </div>
