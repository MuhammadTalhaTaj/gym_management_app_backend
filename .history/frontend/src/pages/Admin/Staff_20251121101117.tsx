        ...
        <div className="bg-[var(--primary-100)] rounded-xl shadow-sm p-6 mb-6">
          <div className="flex flex-col lg:flex-row gap-4 items-start lg:items-center">
            ...
            <div className="flex flex-wrap gap-3">
              ...
              <button className="px-5 py-3 rounded-lg border border-[#8C9BB0]/30 text-[var(--primary-300)] font-medium hover:bg-[#F8FAFC] transition-colors flex items-center gap-2">
