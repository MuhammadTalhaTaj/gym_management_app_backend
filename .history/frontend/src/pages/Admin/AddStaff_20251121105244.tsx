        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2">
            <Card className="p-6 sm:p-8">
              {/* Form Header */}
              <div className="bg-[var(--primary-100)] text-[var(--primary-300)] border-b-4 border-b-[var(--primary-300)] -mx-6 sm:-mx-8 -mt-6 sm:-mt-8 px-6 sm:px-8 py-6 rounded-t-lg mb-8">
