...
const SearchBar = ({ value, onChange }) => (
  <div className="relative flex-1 max-w-md">
    ...
    <input
      ...
      className="w-full pl-12 pr-4 py-3 rounded-lg border border-[#8C9BB0]/30 focus:outline-none focus:ring-2 focus:ring-[#3D8BF2] focus:border-transparent text-[var(--secondary-300)] placeholder:text-[var(--secondary-100)]"
    />
  </div>
);
