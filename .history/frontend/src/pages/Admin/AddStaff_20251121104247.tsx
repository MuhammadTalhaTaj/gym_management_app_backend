  ...
  <div className="flex flex-col gap-2">
    ...
    <div className="relative">
      <input
        ...
        value={value}
        onChange={onChange}
        className="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-lg text-sm text-[var(--primary-200)] placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-[var(--tertiary-400)] focus:border-transparent transition-all"
      />
      {showPasswordToggle && (
        <button
          type="button"
